...
class AudioSTTServiceStub(object):
...
def add_AudioSTTServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'audiosst.AudioSTTService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('audiosst.AudioSTTService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class AudioSTTService(object):
    """Missing associated documentation comment in .proto file."""
